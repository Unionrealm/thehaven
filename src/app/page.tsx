  ...
  return (
    <MobileContainer className="bg-white">
      ...
      <div className="px-5 pb-2">
        ...
        >
          <span aria-hidden className="absolute -top-8 -right-6 w-32 h-32 rounded-full bg-white/10 blur-2xl" />
          <span aria-hidden className="absolute -bottom-10 -left-4 w-28 h-28 rounded-full bg-white/10 blur-2xl" />
          ...
          <div className="relative flex items-center justify-between">
            ...
            <div className="w-12 h-12 bg-white/15 rounded-full flex items-center justify-center shrink-0 ml-3">
              <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
                <path d="M11 4v14M4 11h14" stroke="white" strokeWidth="2.4" strokeLinecap="round" />
              </svg>
            </div>
          </div>
          ...
          <div className="relative mt-5 inline-flex items-center gap-1.5 h-[38px] px-4 bg-white text-[#5a42f5] rounded-[19px] text-[13px] font-semibold">
            ...
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
              <path d="M5 3l4 4-4 4" stroke="#5a42f5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </Link>
      </div>
